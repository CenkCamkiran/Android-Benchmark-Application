/*   ~/workspace/Dhrystone2/jni$ ~/Eclipse/android-ndk-r7/ndk-build
 *************************************************************************
 *
...
int             Int_Glob;
 ...
 jstring
 Java_com_example_androidbenchmarkapp_CPUFragment_stringFromJNI2( JNIEnv* env, jobject thiz)
 {
          One_Fifty   Int_1_Loc;
 ...
 ***********************************************************************/
   ...
   while (count >0);
     ...
     sprintf(resultchars, " Nanoseconds one Dhrystone run%12.0lf \n"
                          " Dhrystones per Second        %12.0lf \n"
                          " VAX MIPS rating              %12.0lf \n",
                          Microseconds * 1000, Dhrystones_Per_Second, Vax_Mips); 
