/*     
 *   ~/workspace/Linpackv7/jni$ ~/Eclipse/android-ndk-r7/ndk-build
 *
...
jstring
Java_com_example_androidbenchmarkapp_CPUFragment_stringFromJNI( JNIEnv* env, jobject thiz)
{
...
// ************************************************************************
    ...
    sprintf(resultchars, " Speed          %10.2f MFLOPS\n\n"
                         " norm. resid    %16.1f\n"
                         " resid          %16.8e\n"
                         " machep         %16.8e\n"
                         " x[0]-1         %16.8e\n"
                         " x[n-1]-1       %16.8e\n\n",
                          max2, (double)residn, (double)resid,
                                (double)epsn, (double)x1, (double)x2);
