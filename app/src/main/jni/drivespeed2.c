/*
  ~/workspace/DriveSpeed2/jni$ ~/Eclipse/android-ndk-r7/ndk-build
*/
...
JNIEXPORT jstring JNICALL Java_com_example_androidbenchmarkapp_IOFragment_doIt(JNIEnv * env, jobject  obj, jint test, jstring path, jint cache, jint dev)
{
