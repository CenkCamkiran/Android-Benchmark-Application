...
public class Benchmark {
    ...
    protected String Android_Results = "Android: ", Requery_Results = "Requery: ";
    ...
    public void runBenchmark() {
        ...
        //Sonuçların yazıldığı yer burası
        Log.i(TAG, "Android: " + android.toString());
        Log.i(TAG, "requery: " + requery.toString());

        Android_Results = android.toString();
        Requery_Results = requery.toString();

        //Deneme amaçlı
        //Log.e("Cenk", Android_Results);
        //Log.e("Cenk", Requery_Results);
